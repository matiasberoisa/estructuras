...
public class TestGrafoEtiquetado {
    public static void main(String[] args) {
        ...
        System.out.println(grafito.toString());
        System.out
                .println("eliminamos un vertices no existente , esperamos rta false  " + grafito.eliminarVertice("J"));
        ...
        System.out.println(grafito.toString());
        System.out.println(
                "Creo un grafo de un solo vertice 'A' y lo recorro en profundidad espero Rta :'A'"
                        + grafito.profundidad());
        grafito.insertarVertice("B");
        grafito.insertarArco("A", "B", 1);
        System.out.println(grafito.toString());
        ...
        System.out.println(grafito.toString());
        System.out
                .println("incerto vertices C , D , E y conexiones B-C-2  C-D-3 Y D-E-4 y recorro espero rta E D C B A "
                        + grafito.profundidad());
