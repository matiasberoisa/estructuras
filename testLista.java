...
public class testLista {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        if (l1 == null) {
            ...
            for (int i = 1; i <= 11; i++) {
                if (i >= 11) {
                    System.out.println("se apilo el objeto 11?(TRUE en dinamica, FALSE en estatica): " + l1.insertar(i, i) + ", arreglo: " + l1.toString());
                } else {
                    System.out.println("se apilo el num " + (i) + "?: " + l1.insertar(i, i) + ", arreglo: " + l1.toString());
                }
            }
        }
